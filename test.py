import unittest
from pattern import is_outdated, is_time_expired, today_date, tomorrow_date
...
class pattern_test(unittest.TestCase):
    def test_is_outdated(self):
        ...
        self.assertFalse(is_outdated(today_date()))
        self.assertFalse(is_outdated('2050/10/10'))
    def test_is_time_expired(self):
        self.assertTrue(is_time_expired('2023/5/23','12:23:23'))
        # self.assertFalse(is_time_expired(today_date(),(datetime.now()+timedelta(minutes=1)).time()))
